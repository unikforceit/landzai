...
<div class="comment-box comments">
	...
	$fields =  array(
		'author' => '<div class="row"><div class="col-lg-6"><div class="form-group comment-form-author"><label for="author"><span class="screen-reader-text">' . esc_attr__( 'Name *'  , 'landzai' ) . '</span></label><input id="author" class="form-control" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" ' . $aria_req . ' placeholder="' . esc_attr__( 'Enter Name here...'  , 'landzai' ) . '"/></div></div>',
		'email'  => '<div class="col-lg-6"><div class="form-group comment-form-email"><label for="email"><span class="screen-reader-text">' . esc_attr__( 'Email *'  , 'landzai' ) . '</span></label><input id="email" name="email" class="form-control" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" ' . $aria_req . ' placeholder="' . esc_attr__( 'Enter email here...'  , 'landzai' ) . '"/></div></div>',
		'url'  => '<div class="col-lg-6"><div class="form-group comment-form-url"><label for="url"><span class="screen-reader-text">' . esc_attr__( 'Website *'  , 'landzai' ) . '</span></label><input id="url" name="url" class="form-control" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) . '" placeholder="' . esc_attr__( 'Enter Your Website...'  , 'landzai' ) . '"/></div></div>',
		'phone'  => '<div class="col-lg-6"><div class="form-group comment-form-phone"><label for="phone"><span class="screen-reader-text">' . esc_attr__( 'Phone *'  , 'landzai' ) . '</span></label><input id="phone" name="phone" class="form-control" type="text" value="' . esc_attr( $commenter['comment_author_phone'] ) . '" placeholder="' . esc_attr__( 'Enter Your Phone...'  , 'landzai' ) . '"/></div></div></div>',
