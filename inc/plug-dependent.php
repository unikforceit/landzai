...
function landzai_single_title($arg){

        if ( is_category() ) {
            /* translators: Category archive title. 1: Category name */
            $title = single_cat_title( $arg['cat'], 'landzai',false);
        } elseif ( is_tag() ) {
            /* translators: Tag archive title. 1: Tag name */
            $title = single_cat_title( $arg['tag'], 'landzai',false);
        } elseif ( is_author() ) {
...
function landzai_unit_breadcumb($separator = '') {
    /* === OPTIONS === */
